...
const Cart = () => {
  ...
  const { showInfoToast, showSuccessToast } = useGlobalToast();
  ...
  const handleCheckout = () => {
    ...
    showSuccessToast("all items purchased and will be delivered soon");
  };

  const removeAllCartItems = () => {
    dispatch(deleteAllCartItems());
    showInfoToast("All Items removed from cart");
  };
  ...
  return (
    <>
      {cartItems && cartItems.length ? (
        <>
          <div className="delete-all-cart-items">
            <button
          ...
          <div className="cart">
                        ...
                        <div className="cart-action-and-delete d-flex justify-content-between">
                          <div className="cart-action-container">
                            <button
                              ...
                              onClick={() =>
                                handleCartItemClick(product, "minus")
                              }
                            ...
                            <button
                              ...
                              onClick={() =>
                                handleCartItemClick(product, "add")
                              }
            ...
            <div className="sub-total">
              <h6 className="text-secondary">
                Your sub total bill is: <strong>$ {getSubTotal()}</strong>
              </h6>
            </div>
